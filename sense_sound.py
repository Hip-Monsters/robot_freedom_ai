...
class  SenseSound(SenseBase):

    def __init__(self,  name, args, pins ={}):
        """
        
        """
        super().__init__(name, args, "noise")
...
if __name__ == "__main__":
    """ 
    python3 sense_sound.py  -m serve -r number_3  -a '{"prompts":["hello"]}'
    """
