...
class  SenseSpeech(SenseBase):

    def __init__(self,  name, args, pins ={}):
        """
        
        """
        super().__init__(name, args, "speech")
...
if __name__ == "__main__":
    """ 
    python3 sense_speech.py  -m serve -r number_3  -a '{"prompts":["hello", "hi", "ok", "number three", "robot"]}'
    """
