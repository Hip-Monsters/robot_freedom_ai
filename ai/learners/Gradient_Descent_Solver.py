"""
Edit from https://github.com/ThomIves/GradientDescentPurePy

We had to pull it in directly to work on our RaspberryPi. 

In the future we intend to import the library instead.

"""

from ai.learners.Plot_Tools import Basic_Plot as BP
import random
...
class Gradient_Descent_Solver:
    def __init__(self, X, Y, LR,
                 ci=1000, tol=1e-12,
                 max_cnt=1e9, rnd=6, weights=None):
        self.X = X
        self.Y = Y
        self.LR = LR
        self.ci = ci
    ...
    def train(self):
        ...
        while cost_delta > self.tol and self.__iterations_below_max__():
            ...
            epoch +=1
            print("\rGradient Descent Learner Epoch "  + str(epoch), end="")
